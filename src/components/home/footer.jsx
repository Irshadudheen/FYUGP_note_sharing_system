...
export function Footer() {
  ...
  return (
    <footer className=" border-border  px-4 py-5  lg:py-12 sm:px-6 lg:px-8">
 
        <div className="mt-6 text-xs  border-t border-border pt-8 text-center md:text-sm text-muted-foreground">
