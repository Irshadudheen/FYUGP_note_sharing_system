  ...
  return (
    <button
            ...
            onError={() => toast.error("Google login failed")}
                className="w-full cursor-pointer flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200"
              >
